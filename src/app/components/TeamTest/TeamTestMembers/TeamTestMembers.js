...
console.log(props)
const allMember = props.teamInfo.members
            ...
            <div className="memberInfoMiddlePart">
                <div className="memberProfileInfo">
                    <div className="memberPhotoDiv">
                        <img src="https://4414.freelancedeveloper.site/storage/app/uploads/seoPages/hqRpMc7CPgjQO5n4tRceijA57Ji7Fjfx5k0kTiL9.png"/>
                        {/*<img className="memberPhoto" src={item.attributes.memberphoto}/>*/}
                    </div>
                    <div className="memberName">{item.attributes.membername}</div>
                    <div className="memberPosition">{item.attributes.memberposition}</div>
                </div>
                <div className="memberInfo">{item.attributes.memberinfo}</div>
            </div>
